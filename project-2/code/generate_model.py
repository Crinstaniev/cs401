...
def main():
    ...
    try:
        ...
        print(time.strftime('%Y-%m-%d %H:%M:%S'),
              '[ML-INFO] data loaded from {}'.format(data_path))
        print(time.strftime('%Y-%m-%d %H:%M:%S'),
              '[ML-INFO] data version: {}'.format(data_version))
    ...
    try:
        print(time.strftime('%Y-%m-%d %H:%M:%S'),
              '[ML-INFO] start model generating')
        ...
        print(time.strftime('%Y-%m-%d %H:%M:%S'),
              '[ML-INFO] model generating success')
        # save to pickle
        with open('./data/model.pkl', 'wb') as f:
            pickle.dump(mdl_with_metadata, f)
            print(time.strftime('%Y-%m-%d %H:%M:%S'), '[ML-INFO] model saved')
    except:
        print(time.strftime('%Y-%m-%d %H:%M:%S'),
              '[ML-INFO] error generating/saving model')
